...
You can divide the messages to namespaced `<locale>/<namespace>.json` files if you prefer so.

:::

:::tip YAML Support

You can create the message translations to `.yaml` or `.yml` files if you prefer so.
