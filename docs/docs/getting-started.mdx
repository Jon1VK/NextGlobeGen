...
:::info Avoiding Common Mistakes

New to NextGlobeGen? Check out the [Common Pitfalls](./common-pitfalls.mdx) guide to avoid frequent mistakes and learn best practices.

:::

## Next Steps

Congratulations! You now have a working internationalized Next.js application. Here's what to explore next:

### 🎨 Enhance Your i18n Setup

**Add More Locales**

- Update `i18n.config.ts` with additional locales
- Create corresponding message files
- Test language switching between all locales

**Organize Messages**

- Split messages into namespaced files: `src/messages/en/common.json`, `src/messages/en/dashboard.json`
- Use namespaces in components: `useTranslations("common")`
- Learn about [message organization](./messages.mdx)

**Localize More Routes**

- Add `i18n.ts` files to translate pathname segments
- Test SEO with translated URLs
- Read about [routing strategies](./routing.mdx)

### 🚀 Advanced Features

**Use Automatic Key Extraction**

- Let NextGlobeGen discover translation keys from your code
- Add `_defaultMessage` for inline defaults: `t("key", { _defaultMessage: "Default" })`
- Enable `pruneUnusedKeys` to remove stale translations
- Learn about [key extraction](./messages.mdx#key-extraction)

**Optimize Bundle Size**

- Configure `clientKeys` to control which messages go to the client
- Use `getMessages()` to provide filtered messages to specific routes
- See [configuration options](./api-reference/configuration.mdx#clientkeys)

**Setup Domain-Based Routing**

- Serve different locales from different domains
- Configure middleware for domain routing
- Read [domain configuration guide](./api-reference/configuration.mdx#domains)

**Add Rich Text Formatting**

- Use ICU message format for plurals, dates, and numbers
- Embed React components in translations
- Learn about [message formatting](./messages.mdx)

### 📚 Learn More

- [NextGlobeGen Playground](https://next-globe-gen-playground.vercel.app) - Interactive examples
- [API Reference](./api-reference/) - Complete API documentation
- [Configuration](./api-reference/configuration.mdx) - All configuration options
- [Testing Guide](./testing.mdx) - Testing strategies for i18n
- [Common Pitfalls](./common-pitfalls.mdx) - Avoid common mistakes and learn best practices
