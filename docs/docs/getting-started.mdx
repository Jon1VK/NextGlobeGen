...
The package has also support for messages in YAML files using `.yaml` or `.yml` extensions.
...
/**
 * If there is dynamic route segments in some of the application routes (ie. "/images/[id]"),
