...
If you need to use custom middleware logic, you can call the middleware yourself with the given request instance and modify the returned response instance.
