...
export default function Footer() {
  return (
    <div className="rounded-lg bg-vc-border-gradient p-px shadow-lg shadow-black/20">
      <div className="text-sm flex flex-col justify-between space-y-2 rounded-lg bg-black p-3.5 lg:px-5 lg:py-4">
        <a
        ...
        <a
          className="underline decoration-dotted underline-offset-4 transition-colors text-gray-400 hover:text-gray-300"
